...
enum RouterVersion {
  InterCroneswapV2Router01 = 'InterCroneswapV2Router01',
  InterCroneswapV2Router02 = 'InterCroneswapV2Router02'
}

describe('InterCroneswapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.InterCroneswapV2Router01]: fixture.router01,
        [RouterVersion.InterCroneswapV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.InterCroneswapV2Router01]: 101876,
              [RouterVersion.InterCroneswapV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.InterCroneswapV2Router01]: 138770,
              [RouterVersion.InterCroneswapV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
